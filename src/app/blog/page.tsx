...
export const POSTS = [
  ...
  {
    slug: 'ascendente-en-tauro',
    title: 'Ascendente en Tauro: solidez, gusto y la fiabilidad que se percibe antes de hablar',
    excerpt: 'El Ascendente en Tauro llega con calma y sensorialidad. Venus como regente, Acuario en el Mediocielo, Escorpio en el Descendente. La presencia venusina que construye cosas duraderas.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-geminis',
    title: 'Ascendente en Géminis: agilidad mental y adaptabilidad como primera impresión',
    excerpt: 'El Ascendente en Géminis llega con curiosidad y facilidad de palabra. Mercurio como regente, Piscis en el Mediocielo, Sagitario en el Descendente. La mente que sintoniza con casi cualquier interlocutor.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-cancer',
    title: 'Ascendente en Cáncer: calidez, sensibilidad y antenas emocionales abiertas',
    excerpt: 'El Ascendente en Cáncer percibe el ambiente antes de analizarlo. La Luna como regente, Aries en el Mediocielo. Lady Gaga y Angelina Jolie como ejemplos documentados. El cuidado como primera presentación al mundo.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-leo',
    title: 'Ascendente en Leo: magnetismo, generosidad y presencia que ocupa espacio',
    excerpt: 'El Ascendente en Leo llega con calidez y una energía que convoca la atención de forma natural. El Sol como regente, Tauro en el Mediocielo, Acuario en el Descendente. La diferencia entre brillar e iluminar.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-libra',
    title: 'Ascendente en Libra: elegancia, equilibrio y diplomacia como presentación al mundo',
    excerpt: 'El Ascendente en Libra llega con armonía perceptible. Venus como regente, Cáncer en el Mediocielo. JFK como ejemplo documentado. La diferencia entre la diplomacia genuina y la evitación del conflicto necesario.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-sagitario',
    title: 'Ascendente en Sagitario: optimismo, expansión y visión de conjunto',
    excerpt: 'El Ascendente en Sagitario llega con entusiasmo y apertura hacia algo más grande. Júpiter como regente, Virgo en el Mediocielo. Elvis Presley como ejemplo documentado. La visión que necesita el detalle para aterrizar.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-capricornio',
    title: 'Ascendente en Capricornio: seriedad, estructura y la autoridad que llega con el tiempo',
    excerpt: 'El Ascendente en Capricornio proyecta competencia y reserva. Saturno como regente, Libra en el Mediocielo. La disciplina que construye cosas duraderas y el trabajo de aprender a habitar el presente.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-acuario',
    title: 'Ascendente en Acuario: originalidad, independencia y perspectiva poco convencional',
    excerpt: 'El Ascendente en Acuario llega diferente: perspectiva propia, distancia calculada, inteligencia que ve más allá del consenso. Saturno y Urano como co-regentes, Escorpio en el Mediocielo.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
    slug: 'ascendente-en-piscis',
    title: 'Ascendente en Piscis: sensibilidad, apertura y la profundidad que el mundo percibe primero',
    excerpt: 'El Ascendente en Piscis llega sin bordes rígidos: permeabilidad emocional, empatía profunda y una presencia que el entorno percibe antes de entenderla. Michael Jackson como ejemplo documentado. Júpiter y Neptuno como co-regentes.',
    category: 'Astrología',
    date: '2026-07-20',
  },
  {
